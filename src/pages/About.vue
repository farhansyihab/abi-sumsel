    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="section-header">
          <h2>Tentang Kami</h2>
          <p>Berikut ini visi dan Misi serta sejarah ABI</p>
        </div>

        <div class="row gy-4">
          <div class="col-lg-6">
            <h3><span>Visi &#038; Misi Ahlulbait Indonesia</span></h3>
            <p style="text-align: justify;"><strong>Visi: </strong></p>
            <ul style="text-align: justify;">
            <li>Mewujudkan masyarakat Ahlulbait Indonesia yang mencintai Tanah Air, menjunjung tinggi perikemanusiaan, menjaga persatuan dan kesatuan nasional serta menumbuhkan ukhiwah Islamiyyah.</li>
            </ul>
            <p style="text-align: justify;"><strong>Misi:</strong></p>
            <ul style="text-align: justify;">
            <li>Mengamalkan tuntunan Rasulullah saw dan Ahlulbaitnya dengan membela dan menegakkan Negara Kesatuan Republik Indonesia berdasarkan Pancasila dan UUD 1945.</li>
            <li>Memperjuangkan penghapusan segala bentuk penindasan, rasisme, fanatisme golongan dan tindakan-tindakan anti-kemanusiaan lainnya.</li>
            <li>Memelihara persatuan dan kesatuan Bangsa Indonesia dengan segala kebhinekaannya.</li>
            <li>Berperan aktif mewujudkan dan memelihara ukhuwah Islamiyyah.</li>
            <li>Mewujudkan masyarakat Ahlulbait yang mandiri dalam bidang sosial, budaya dan ekonomi.</li>
            </ul>
          </div>
          <div class="col-lg-6">
